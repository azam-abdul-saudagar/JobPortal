...
{
    public partial class AdminFeedbackPg : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            using (SqlConnection con = new SqlConnection(CS))
            {
                ...
                cmd.CommandText = "SELECT * FROM tblFeedback;";
                cmd.Connection = con;
                con.Open();
          ...
          "<div class='col-lg-3'>" +
              ...
              "<form class='' action='AdminActions.aspx' method='post'>" +
                ...
                "<button class='job-btn btn btn-success mb-4' type='submit' name='Action' value='RemoveFeedback'>Remove Feedback</button>" +
              "</form>" +
            "</div>" +
          "</div>" +
        "</div>";
